package pdfact.cli.pipes.serialize.plain;

import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.B;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.CHARACTER;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.COLOR;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.COLORS;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.DOCUMENT;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.FONT;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.FONTS;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.FONTSIZE;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.G;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.ID;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.MAX_X;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.MAX_Y;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.MIN_X;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.MIN_Y;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.NAME;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.PAGE;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.PARAGRAPH;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.PDF;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.POSITION;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.POSITIONS;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.R;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.ROLE;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.TEXT;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.TEXT_BLOCK;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.TEXT_LINE;
import static pdfact.cli.pipes.serialize.plain.PlainPdfSerializerConstants.WORD;
