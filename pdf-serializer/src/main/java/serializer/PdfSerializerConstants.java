...
public class PdfSerializerConstants {
  ...
  protected static final String CONTEXT_NAME_ELEMENT_FONT = "font";
  /** The name of context where to put the fontsize of a text element. */
  protected static final String CONTEXT_NAME_ELEMENT_FONT_SIZE = "fontsize";
  /** The name of context where to put the color of a serialized element. */
  protected static final String CONTEXT_NAME_ELEMENT_COLOR = "color";
