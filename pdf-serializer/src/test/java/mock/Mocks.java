...
public class Mocks {
  ...
  public static PdfCharacter mockCharacter1(PdfDocument doc, PdfPage page) {
    ...
    when(char1.getRole()).thenReturn(PdfRole.UNKNOWN);
    when(char1.getText(anyBoolean(), anyBoolean(), anyBoolean()))
        .thenReturn("a");
    when(char1.getTextCharacters()).thenReturn(Arrays.asList(char1));
  ...
  public static PdfCharacter mockCharacter2(PdfDocument doc, PdfPage page) {
    ...
    when(char2.getRole()).thenReturn(PdfRole.UNKNOWN);
    when(char2.getText(anyBoolean(), anyBoolean(), anyBoolean()))
        .thenReturn("b");
    when(char2.getTextCharacters()).thenReturn(Arrays.asList(char2));
  ...
  public static PdfFigure mockFigure1(PdfDocument document, PdfPage page) {
    ...
    when(figure1.getRole()).thenReturn(PdfRole.FIGURE);
  ...
  public static PdfFigure mockFigure2(PdfDocument document, PdfPage page) {
    ...
    when(figure2.getRole()).thenReturn(PdfRole.FIGURE);
  ...
  public static PdfShape mockShape1(PdfDocument document, PdfPage page) {
    ...
    when(shape1.getRole()).thenReturn(PdfRole.FIGURE);
  ...
  protected static String toXml(PdfCharacter character) {
    ...
    xml.append(indent);
    xml.append("<");
    xml.append(character.getFeature().getFieldName());
  ...
  protected static String toTsv(PdfCharacter character) {
    ...
    tsv.append(character.getFeature().getFieldName());
    tsv.append("\t");
  ...
  protected static String toXml(PdfFigure figure) {
    ...
    xml.append(indent);
    xml.append("<");
    xml.append(figure.getFeature().getFieldName());
  ...
  protected static String toTsv(PdfFigure figure) {
    ...
    tsv.append(figure.getFeature().getFieldName());
    tsv.append("\t");
  ...
  protected static String toXml(PdfShape shape) {
    ...
    xml.append(indent);
    xml.append("<");
    xml.append(shape.getFeature().getFieldName());
  ...
  protected static String toTsv(PdfShape shape) {
    ...
    tsv.append(shape.getFeature().getFieldName());
    tsv.append("\t");
