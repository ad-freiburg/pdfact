...
/**
 * Tests for the XmlPdfSerializerTest.
 *
 * @author Claudius Korzen
 */
@RunWith(MockitoJUnitRunner.class)
public class XmlPdfSerializerTest {
  /**
   * The path to the resources dir.
   */
  final String resourcesPath = "src/test/resources/XmlPdfSerializerTest";
  
  /**
   * The serializer under test.
   */
  XmlPdfSerializer serializer;
  ...
  @Before
  public void setup() {
    this.serializer = new XmlPdfSerializer();
  }
