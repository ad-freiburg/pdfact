...
public class PdfSerializerConstants {
   ...
   */
  static final String CONTEXT_NAME_ELEMENT_BOUNDING_BOX = "boundingBox";
   ...
   */
  static final String CONTEXT_NAME_ELEMENT_MOST_COMMON_FONT = "mostCommonFont";
  /** The name of context where to put the fontsize of a text element. */
  static final String CONTEXT_NAME_ELEMENT_MOST_COMMON_FONT_SIZE =
      "mostCommonFontsize";
  /** The name of context where to put the font of the first character. */
  static final String CONTEXT_NAME_ELEMENT_FIRST_CHARACTER_FONT = "startFont";
  /** The name of context where to put the fontsize of the first character. */
  static final String CONTEXT_NAME_ELEMENT_FIRST_CHARACTER_FONTSIZE =
      "startFontsize";
  /** The name of context where to put the font of the last character. */
  static final String CONTEXT_NAME_ELEMENT_LAST_CHARACTER_FONT = "endFont";
  /** The name of context where to put the fontsize of the last character. */
  static final String CONTEXT_NAME_ELEMENT_LAST_CHARACTER_FONTSIZE =
      "endFontsize";
  /** The name of context where to put the color of a serialized element. */
  static final String CONTEXT_NAME_ELEMENT_MOST_COMMON_COLOR =
      "mostCommonColor";
  /** The name of context where to put the color of the first character. */
  static final String CONTEXT_NAME_ELEMENT_FIRST_CHARACTER_COLOR = "startColor";
  /** The name of context where to put the color of the last character. */
  static final String CONTEXT_NAME_ELEMENT_LAST_CHARACTER_COLOR = "endColor";
  /** The name of context where to put the id of a serialized font. */
  static final String CONTEXT_NAME_FONT_ID = "id";
  /** The name of context where to put the name of a serialized font. */
  static final String CONTEXT_NAME_FONT_NAME = "name";
  ...
  static final String CONTEXT_NAME_COLOR_ID = "id";
