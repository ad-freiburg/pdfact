...
// */
// public class FloatCounter2<T> extends TFloatObjectHashMap<Set<T>> {
// /**
...
// */
// public FloatCounter2(int initialCapacity) {
...
// boolean removed = containsKey(f) && get(f).remove(object);
// if (removed) {
// // TODO: Compute
// }
// }
...
// return get(this.mostFrequentFloat);
// }
//
// //
// ==========================================================================
...
// for (float f : this.allMostFrequentFloats) {
...
// return get(this.leastFrequentFloat);
// }
//
// //
// ==========================================================================
...
// Set<T> allObjects = new HashSet<>();
// for (float f : this.allLeastFrequentFloats) {
// allObjects.addAll(get(f));
// }
// return allObjects;
// }
...
// * Counts the frequencies of the floats.
// */
// protected void unregisterElement(T element) {
// resetComputedValues();
//
// float sumFloats = 0;
// float numFloats = 0;
