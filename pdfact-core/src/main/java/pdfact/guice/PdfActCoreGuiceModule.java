...
import pdfact.models.plain.PlainPdfTextLineStatistic;
...
import pdfact.parse.stream.pdfbox.guice.PdfBoxOperatorProcessorGuiceModule;
...
public class PdfActCoreGuiceModule extends com.google.inject.AbstractModule {
  ...
  protected void configure() {
    ...
    install(new FactoryModuleBuilder()
        .implement(PdfTextLineStatistic.class, PlainPdfTextLineStatistic.class)
