package pdfact.utils.geometric.plain;
...
import pdfact.utils.geometric.Geometric;
...
public class PlainRectangle extends Rectangle {
   ...
   */
  @AssistedInject
  public PlainRectangle(@Assisted("point1") Point point1,
   ...
   */
  @AssistedInject
  public PlainRectangle(@Assisted("minX") double minX,
   ...
   */
  @AssistedInject
  public PlainRectangle(@Assisted("minX") float minX,
