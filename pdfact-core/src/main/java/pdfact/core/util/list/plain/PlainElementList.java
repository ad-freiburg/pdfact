package pdfact.core.util.list.plain;
...
/**
 * A plain implementation of {@link ElementList}.
 * 
 * @param <T>
 ...
 */
public class PlainElementList<T extends Element> implements ElementList<T> {
  /**
   * The underlying list.
   */
   ...
   */
  @AssistedInject
  public PlainElementList(@Assisted int initialCapacity) {
   ...
   *        The type of the PDF elements in this list.
   */
  class ElementListView<S extends Element> implements ElementList<S> {
    /**
     * The serial id.
     */
...
class Quicksort {
   ...
   */
  public static <T extends Element> void sort(ElementList<T> list,
   ...
   *        The end index.
   */
  protected static <T extends Element> void quickSortRecursive(
      ElementList<T> list, Comparator<? super T> c, int l, int r) {
   ...
   */
  protected static <T extends Element> int quickSortDivide(
      ElementList<T> list, Comparator<? super T> c, int l, int r) {
