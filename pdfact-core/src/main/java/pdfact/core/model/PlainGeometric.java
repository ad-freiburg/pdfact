 ...
 */
public abstract class PlainGeometric implements HasRectangle {
  /**
   ...
   */
  public boolean contains(PlainGeometric g) {
    if (g == null) {
      return false;
    }
   ...
   */
  public boolean overlaps(PlainGeometric g) {
    if (g == null) {
      return false;
    }
   ...
   *         horizontally.
   */
  public boolean overlapsHorizontally(PlainGeometric g) {
    if (g == null) {
      return false;
    }
    Rectangle rect = g.getRectangle();
   ...
   *         vertically.
   */
  public boolean overlapsVertically(PlainGeometric g) {
    if (g == null) {
      return false;
    }
    Rectangle rect = g.getRectangle();
   ...
   */
  public float computeOverlapArea(PlainGeometric g) {
   ...
   */
  public float computeVerticalOverlapLength(PlainGeometric g) {
    if (g == null) {
      return 0;
    }
    Rectangle rect = getRectangle();
   ...
   * @return The length of the vertical overlap
   */
  public float computeHorizontalOverlapLength(PlainGeometric g) {
    if (g == null) {
      return 0;
    }
    Rectangle rect = getRectangle();
