...
/**
 * A text block in a page of a document. In principal, a text block is equal to
 * a paragraph, if a paragraph spans only a single page. In contrast, if a
 * paragraph spans two pages, the paragraph consists of two text blocks.
 * 
 * @author Claudius Korzen
 */
public class TextBlock extends Element implements HasTextLines, HasText, HasPosition, 
    HasSemanticRole {
  /**
  ...
  public boolean equals(Object other) {
    if (other instanceof TextBlock) {
      ...
      builder.append(getSecondarySemanticRole(), otherTextBlock.getSecondarySemanticRole());
