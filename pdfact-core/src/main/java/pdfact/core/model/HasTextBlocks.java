...
/**
 * An interface to implement by elements that consist of at least one text
 * block.
 *
 * @author Claudius Korzen
 */
public interface HasTextBlocks extends HasTextLineStatistic, HasCharacterStatistic {
  /**
   ...
   * 
   * @param blocks The text blocks of this element.
   */
   ...
   * 
   * @param blocks The text blocks to add.
   */
   ...
   * 
   * @param block The text block to add.
   */
