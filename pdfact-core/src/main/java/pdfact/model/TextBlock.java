...
/**
 * A text block in a page of a PDF document. In principal, a text block is 
 * equal to a paragraph, if a paragraph spans only a single page. In contrast,
 * if a paragraph spans two pages, the paragraph consists of two text blocks.
 * 
