...
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.B;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.CHARACTER;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.COLOR;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.COLORS;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.DOCUMENT;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.FONT;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.FONTS;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.FONTSIZE;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.G;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.ID;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.MAX_X;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.MAX_Y;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.MIN_X;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.MIN_Y;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.NAME;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.PAGE;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.PARAGRAPH;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.PDF;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.POSITION;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.POSITIONS;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.R;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.ROLE;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.TEXT;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.TEXT_BLOCK;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.TEXT_LINE;
import static pdfact.pipes.serialize.plain.PlainPdfSerializerConstants.WORD;
