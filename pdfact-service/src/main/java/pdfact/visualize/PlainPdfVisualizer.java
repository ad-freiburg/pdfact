...
public class PlainPdfVisualizer implements PdfVisualizer {
  ...
  @Override
  public void visualize(PdfDocument pdf, OutputStream stream,
      Set<PdfTextUnit> features, Set<PdfRole> roles) throws IOException {
  ...
  protected boolean isVisualizePdfElement(PdfElement element,
      Set<PdfTextUnit> features, Set<PdfRole> roles) {
    ...
    if (isFeatureGiven && !features.contains(element.getTextUnit())) {
      return false;
    }
